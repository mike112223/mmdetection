...
def assigner_iou_analysis():
    ...
    for img in data:
        ...
        nums_small_list.append(nums[area_index['8small']])
        nums_small_list.append(nums[area_index['10small']])
        nums_small_list.append(nums[area_index['12small']])
        nums_small_list.append(nums[area_index['14small']])
        nums_small_list.append(nums[area_index['16small']])
        nums_small_list.append(nums[area_index['24small']])
        nums_small_list.append(nums[area_index['32small']])
