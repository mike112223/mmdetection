...
# optimizer
optimizer = dict(type='SGD', lr=0.000015, momentum=0.9, weight_decay=5e-4)
...
log_level = 'INFO'
load_from = 'work_dirs/retinaface_quartrain_data+aug_ignore9_nosub1_anchor_lr0.005/epoch_97.pth'
resume_from = None
workflow = [('train', 1)]
