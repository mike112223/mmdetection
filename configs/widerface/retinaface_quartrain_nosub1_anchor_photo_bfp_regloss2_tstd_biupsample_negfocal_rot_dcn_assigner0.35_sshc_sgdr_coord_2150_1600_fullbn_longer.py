...
log_level = 'INFO'
load_from = 'work_dirs/retinaface_quartrain_nosub1_anchor_photo_bfp_regloss2_tstd_biupsample_negfocal_rot_dcn_assigner0.35_sshc_sgdr_coord_2150_1600_fullbn/latest.pth'
resume_from = None
workflow = [('train', 1)]
