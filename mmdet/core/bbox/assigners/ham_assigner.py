...
class HAMAssigner(BaseAssigner):
    ...
    def assign(self, bboxes, gt_bboxes, proposals, gt_bboxes_ignore=None, gt_labels=None):
        """Assign gt to bboxes.
        ...
        assign_result = self.assign_wrt_overlaps(overlaps, gt_bboxes, proposals, gt_labels)
        if assign_on_cpu:
    ...
    def assign_wrt_overlaps(self, overlaps, gt_bboxes, proposals, gt_labels=None):
