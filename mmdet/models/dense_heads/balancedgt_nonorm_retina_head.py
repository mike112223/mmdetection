...
class BalancedGtNoNormRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(BalancedGtNoNormRetinaHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def _get_targets_single(self,
        ...
        gt_weights = torch.reciprocal(
            torch.clamp_min(
                torch.bincount(sampling_result.pos_assigned_gt_inds).float(),
                1.0))
        ...
        if len(pos_inds) > 0:
            ...
            if self.train_cfg.pos_weight <= 0:
                label_weights[pos_inds] = gt_weights[
                    sampling_result.pos_assigned_gt_inds]
            else:
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        loss_cls = self.loss_cls(
            cls_score, labels, label_weights, avg_factor=self.batch)
        # regression loss
