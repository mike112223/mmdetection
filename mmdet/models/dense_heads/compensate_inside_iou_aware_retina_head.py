...
from mmdet.core import (anchor_inside_flags, force_fp32, images_to_levels,
                        build_assigner, multi_apply, unmap, bbox_overlaps,
                        multiclass_nms)


@HEADS.register_module()
class CompensateInsideIouAwareRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(CompensateInsideIouAwareRetinaHead, self).__init__(
            num_classes,
            in_channels,
        ...
        for i in range(len(gt_bboxes)):
            ...
            if num_compensated > 0 and len(mask_idx) > 0:
                ...
                if len(candidate_inds) > 0:
                    ...
                    # print('recall', len(candidate_inds[:num_compensated]), len(left_inds))
    ...
    def loss_single(self, cls_score, bbox_pred, iou_pred, anchors, labels,
        ...
        # print(num_total_samples, recall_num_total_samples, len(pos_inds))
