...
from mmdet.core import (anchor_inside_flags, force_fp32, images_to_levels,
                        multi_apply, unmap, build_assigner, bbox_overlaps)
...
class HAMRetinaHead(AnchorHead):
    ...
    def _get_targets_single(self,
        ...
        if unmap_outputs:
            ...
            compensates = unmap(compensates, num_total_anchors, inside_flags)

        return (labels, label_weights, bbox_targets, bbox_weights, pos_inds,
                neg_inds, sampling_result, compensates)
    ...
    def loss(self,
        ...
        (labels_list, label_weights_list, bbox_targets_list, bbox_weights_list,
         num_total_pos, num_total_neg, compensates_list) = cls_reg_targets
        num_total_samples = (
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
                    bbox_targets, bbox_weights, compensates, num_total_samples):
        ...
        compensates = compensates.reshape(-1)
        ...
        compensate_inds = compensates.nonzero().squeeze(1)
        num_compensate = len(compensate_inds)
        left_inds = (compensates == 0).nonzero().squeeze(1)
        ...
        if num_compensate > 0:
            # dx, dy, dw, dh
            pos_bbox_targets = bbox_targets[compensate_inds]
            # tx, ty, tw, th
            pos_bbox_pred = bbox_pred[compensate_inds]
            # x1, y1, x2, y2
            pos_anchors = anchors[compensate_inds]
            # x1, y1, x2 ,y2
            ...
            all_loss_cls += compensate_loss_cls
            all_loss_bbox += compensate_loss_bbox

        return all_loss_cls, all_loss_bbox
