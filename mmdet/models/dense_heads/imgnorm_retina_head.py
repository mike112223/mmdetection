...
class ImgNormRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(ImgNormRetinaHead, self).__init__(
            num_classes,
            in_channels,
    ...
    def _get_targets_single(self,
        ...
        if len(pos_inds) > 0:
            ...
            bbox_weights[pos_inds, :] = 1. / len(pos_inds)
            ...
            if self.train_cfg.pos_weight <= 0:
                label_weights[pos_inds] = 1.0 / len(pos_inds)
            else:
                label_weights[pos_inds] = self.train_cfg.pos_weight
        if len(neg_inds) > 0:
            label_weights[neg_inds] = 1.0 / max(1.0, len(pos_inds))
