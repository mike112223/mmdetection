...
class SSHC(nn.Module):
    ...
    def forward(self, input):
        ...
        for i in range(self.num_levels):
            x = input[i]
            if self.share:
                x_3 = self.level_ssh_convs[0][0](x)

                x_5_1 = self.level_ssh_convs[0][1](x)
                x_5 = self.level_ssh_convs[0][2](x_5_1)

                x_7_2 = self.level_ssh_convs[0][3](x_5_1)
                x_7 = self.level_ssh_convs[0][4](x_7_2)
            else:
                x_3 = self.level_ssh_convs[i][0](x)

                x_5_1 = self.level_ssh_convs[i][1](x)
                x_5 = self.level_ssh_convs[i][2](x_5_1)
